...
function getSpotifyLink(uri) {
    var _uri_split = _sliced_to_array(uri.split(":"), 3), tmp = _uri_split[1], type = tmp === void 0 ? "" : tmp, tmp1 = _uri_split[2], id = tmp1 === void 0 ? "" : tmp1;
...
function getSpotifyURIType(uri) {
    var _uri_split = _sliced_to_array(uri.split(":"), 2), tmp = _uri_split[1], type = tmp === void 0 ? "" : tmp;
    return type;
}
...
function getAlbumImage(album) {
    ...
    var maxWidth = (_Math = Math).max.apply(_Math, _to_consumable_array(album.images.map(function(d) {
        return d.width || 0;
    })));
...
function validateURI(input) {
    ...
    if (input && input.indexOf(":") > -1) {
        var _input_split = _sliced_to_array(input.split(":"), 3), key = _input_split[0], type = _input_split[1], id = _input_split[2];
...
__export(spotify_exports, {
    checkTracksStatus: function() {
        return checkTracksStatus;
    },
    getDevices: function() {
        return getDevices;
    },
...
function _checkTracksStatus() {
    _checkTracksStatus = _async_to_generator(function(token, tracks) {
        var ids;
...
function _getDevices() {
    _getDevices = _async_to_generator(function(token) {
        return _ts_generator(this, function(_state) {
            return [
                2,
...
function _getPlaybackState() {
    _getPlaybackState = _async_to_generator(function(token) {
        return _ts_generator(this, function(_state) {
            return [
                2,
...
function _getQueue() {
    _getQueue = _async_to_generator(function(token) {
        return _ts_generator(this, function(_state) {
            return [
                2,
...
function next(token, deviceId) {
    return _next.apply(this, arguments);
}
function _next() {
    _next = _async_to_generator(function(token, deviceId) {
        var query;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    ...
                    return [
                        4,
                        fetch("https://api.spotify.com/v1/me/player/next".concat(query), {
                            headers: {
                                Authorization: "Bearer ".concat(token),
                                "Content-Type": "application/json"
                            },
...
function pause(token, deviceId) {
    return _pause.apply(this, arguments);
}
function _pause() {
    _pause = _async_to_generator(function(token, deviceId) {
        var query;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    ...
                    return [
                        4,
                        fetch("https://api.spotify.com/v1/me/player/pause".concat(query), {
                            headers: {
                                Authorization: "Bearer ".concat(token),
                                "Content-Type": "application/json"
                            },
...
function _play() {
    _play = _async_to_generator(function(token, param) {
...
function previous(token, deviceId) {
    return _previous.apply(this, arguments);
}
function _previous() {
    _previous = _async_to_generator(function(token, deviceId) {
        var query;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    ...
                    return [
                        4,
                        fetch("https://api.spotify.com/v1/me/player/previous".concat(query), {
                            headers: {
                                Authorization: "Bearer ".concat(token),
                                "Content-Type": "application/json"
                            },
...
function _removeTracks() {
    _removeTracks = _async_to_generator(function(token, tracks) {
        var ids;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
...
function repeat(token, state, deviceId) {
    return _repeat.apply(this, arguments);
}
function _repeat() {
    _repeat = _async_to_generator(function(token, state, deviceId) {
        var query;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    ...
                    return [
                        4,
                        fetch("https://api.spotify.com/v1/me/player/repeat".concat(query), {
                            headers: {
                                Authorization: "Bearer ".concat(token),
                                "Content-Type": "application/json"
                            },
...
function _saveTracks() {
    _saveTracks = _async_to_generator(function(token, tracks) {
        var ids;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
...
function seek(token, position, deviceId) {
    return _seek.apply(this, arguments);
}
function _seek() {
    _seek = _async_to_generator(function(token, position, deviceId) {
        var query;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    ...
                    return [
                        4,
                        fetch("https://api.spotify.com/v1/me/player/seek".concat(query), {
                            headers: {
                                Authorization: "Bearer ".concat(token),
                                "Content-Type": "application/json"
                            },
...
function _setDevice() {
    _setDevice = _async_to_generator(function(token, deviceId, shouldPlay) {
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    return [
...
function setVolume(token, volume, deviceId) {
    return _setVolume.apply(this, arguments);
}
function _setVolume() {
    _setVolume = _async_to_generator(function(token, volume, deviceId) {
        var query;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    ...
                    return [
                        4,
                        fetch("https://api.spotify.com/v1/me/player/volume".concat(query), {
                            headers: {
                                Authorization: "Bearer ".concat(token),
                                "Content-Type": "application/json"
                            },
...
function shuffle(token, state, deviceId) {
    return _shuffle.apply(this, arguments);
}
function _shuffle() {
    _shuffle = _async_to_generator(function(token, state, deviceId) {
        var query;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    ...
                    return [
                        4,
                        fetch("https://api.spotify.com/v1/me/player/shuffle".concat(query), {
                            headers: {
                                Authorization: "Bearer ".concat(token),
                                "Content-Type": "application/json"
                            },
...
function Next(props) {
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("svg", _object_spread_props(_object_spread({
        height: "1em",
...
function Pause(props) {
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("svg", _object_spread_props(_object_spread({
        height: "1em",
        preserveAspectRatio: "xMidYMid",
        viewBox: "0 0 64 64",
        width: "1em"
...
function Play(props) {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("svg", _object_spread_props(_object_spread({
        height: "1em",
        preserveAspectRatio: "xMidYMid",
        viewBox: "0 0 64 64",
        width: "1em"
...
function Previous(props) {
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("svg", _object_spread_props(_object_spread({
        height: "1em",
        preserveAspectRatio: "xMidYMid",
        viewBox: "0 0 64 64",
        width: "1em"
...
function Controls(props) {
    var tmp = props.components, _ref = tmp === void 0 ? {} : tmp, leftButton = _ref.leftButton, rightButton = _ref.rightButton, devices = props.devices, durationMs = props.durationMs, isActive = props.isActive, isExternalDevice = props.isExternalDevice, isMagnified = props.isMagnified, isPlaying = props.isPlaying, layout = props.layout, locale = props.locale, nextTracks = props.nextTracks, onChangeRange = props.onChangeRange, onClickNext = props.onClickNext, onClickPrevious = props.onClickPrevious, onClickTogglePlay = props.onClickTogglePlay, onToggleMagnify = props.onToggleMagnify, position = props.position, progressMs = props.progressMs, styles = props.styles, volume = props.volume;
...
function ClickOutside(props) {
    var children = props.children, isActive = props.isActive, onClick = props.onClick, rest = _object_without_properties(props, [
        "children",
        "isActive",
        "onClick"
    ]);
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", _object_spread_props(_object_spread({
        ref: containerRef
    }, rest), {
        children: children
    }));
...
function DevicesIcon(props) {
    return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("svg", _object_spread_props(_object_spread({
        height: "1em",
        preserveAspectRatio: "xMidYMid",
        viewBox: "0 0 64 64",
        width: "1em"
...
function DevicesComputerIcon(props) {
    return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("svg", _object_spread_props(_object_spread({
        height: "1em",
        preserveAspectRatio: "xMidYMid",
        viewBox: "0 0 64 64",
        width: "1em"
...
function DevicesMobileIcon(props) {
    return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("svg", _object_spread_props(_object_spread({
        height: "1em",
        preserveAspectRatio: "xMidYMid",
        viewBox: "0 0 64 64",
        width: "1em"
...
function DevicesSpeakerIcon(props) {
    return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("svg", _object_spread_props(_object_spread({
        height: "1em",
        preserveAspectRatio: "xMidYMid",
        viewBox: "0 0 64 64",
        width: "1em"
...
var Wrapper4 = styled("div")({
    ...
    var divStyles = isCompact ? {
        bottom: "120%",
        left: 0
    } : (_obj = {}, _define_property(_obj, style.p, "120%"), _define_property(_obj, "left", 0), _define_property(_obj, "@media (min-width: 768px)", {
        left: "auto",
        right: 0
    }), _obj);
    var _obj1;
    var spanStyles = isCompact ? {
        ...
        left: px(10)
    } : (_obj1 = {}, _define_property(_obj1, style.p === "top" ? "border-bottom" : "border-top", "6px solid #000"), _define_property(_obj1, style.p, "-6px"), _define_property(_obj1, "left", px(10)), _define_property(_obj1, "@media (min-width: 768px)", {
        left: "auto",
        right: px(10)
    }), _obj1);
    return {
        ...
        "> div": _object_spread_props(_object_spread({}, divStyles), {
            "> span": spanStyles
        })
    };
}, "DevicesRSWP");
...
function Devices(props) {
    var currentDeviceId = props.currentDeviceId, deviceId = props.deviceId, _props_devices = props.devices, devices = _props_devices === void 0 ? [] : _props_devices, layout = props.layout, locale = props.locale, onClickDevice = props.onClickDevice, open = props.open, playerPosition = props.playerPosition, color = props.styles.color;
    var _ref = _sliced_to_array((0, import_react6.useState)(open), 2), isOpen = _ref[0], setOpen = _ref[1];
...
function useMediaQuery(input) {
    ...
    var _ref = _sliced_to_array((0, import_react7.useState)(getMatches(input)), 2), matches = _ref[0], setMatches = _ref[1];
...
function Favorite(props) {
    return /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("svg", _object_spread_props(_object_spread({
        height: "1em",
        preserveAspectRatio: "xMidYMid",
        viewBox: "0 0 64 64",
        width: "1em"
...
function FavoriteOutline(props) {
    return /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("svg", _object_spread_props(_object_spread({
        height: "1em",
        preserveAspectRatio: "xMidYMid",
        viewBox: "0 0 64 64",
        width: "1em"
...
function SpotifyLogo(_param) {
    var bgColor = _param.bgColor, rest = _object_without_properties(_param, [
        "bgColor"
    ]);
    return /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("svg", _object_spread_props(_object_spread({
        height: "1em",
        preserveAspectRatio: "xMidYMid",
        viewBox: "0 0 512 160",
        width: "3.2em"
...
function Info(props) {
    ...
    var _ref = _sliced_to_array((0, import_react8.useState)(false), 2), isSaved = _ref[0], setIsSaved = _ref[1];
...
var Player = (0, import_react9.forwardRef)(function(_param, ref) {
    var children = _param.children, _param_styles = _param.styles, bgColor = _param_styles.bgColor, height = _param_styles.height, rest = _object_without_properties(_param, [
        "children",
        "styles"
    ]);
    return /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("div", _object_spread_props(_object_spread({
        ref: ref,
...
function VolumeHigh(props) {
    return /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("svg", _object_spread_props(_object_spread({
...
function VolumeLow(props) {
    return /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("svg", _object_spread_props(_object_spread({
...
function VolumeHigh2(props) {
    return /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("svg", _object_spread_props(_object_spread({
...
function VolumeMute(props) {
    return /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("svg", _object_spread_props(_object_spread({
...
var WrapperWithToggle = styled("div")({
    ...
    var spanStyles = isCompact ? {
        bottom: "-".concat(px(6)),
        borderTop: "6px solid #000"
    } : (_obj = {}, _define_property(_obj, style.p === "top" ? "border-bottom" : "border-top", "6px solid #000"), _define_property(_obj, style.p, "-6px"), _obj);
    var _obj1;
    return {
        "> button": {
            color: style.c
        },
        "> div": (_obj1 = {}, _define_property(_obj1, isCompact ? "bottom" : style.p, "130%"), _define_property(_obj1, "> span", spanStyles), _obj1)
    };
}, "VolumeRSWP");
...
function Volume(props) {
    ...
    var _ref1 = _sliced_to_array((0, import_react10.useState)(volume), 2), volumeState = _ref1[0], setVolumeState = _ref1[1];
...
var SpotifyWebPlayer = /*#__PURE__*/ function(_import_react12_PureComponent) {
    ...
    var _super = _create_super(SpotifyWebPlayer);
    function SpotifyWebPlayer(props) {
        _class_call_check(this, SpotifyWebPlayer);
        var _this;
        _this = _super.call(this, props);
        __publicField(_assert_this_initialized(_this), "isMounted", false);
        __publicField(_assert_this_initialized(_this), "emptyTrack", {
            artists: [],
            durationMs: 0,
            id: "",
            image: "",
        ...
        __publicField(_assert_this_initialized(_this), "locale");
        __publicField(_assert_this_initialized(_this), "player");
        __publicField(_assert_this_initialized(_this), "playerProgressInterval");
        __publicField(_assert_this_initialized(_this), "playerSyncInterval");
        __publicField(_assert_this_initialized(_this), "ref", (0, import_react12.createRef)());
        __publicField(_assert_this_initialized(_this), "renderInlineActions", false);
        __publicField(_assert_this_initialized(_this), "resizeTimeout");
        __publicField(_assert_this_initialized(_this), "seekUpdateInterval", 100);
        __publicField(_assert_this_initialized(_this), "styles");
        __publicField(_assert_this_initialized(_this), "syncTimeout");
        // eslint-disable-next-line unicorn/consistent-function-scoping
        __publicField(_assert_this_initialized(_this), "getPlayOptions", (0, import_memoize_one.default)(function(ids) {
            var playOptions = {
                context_uri: void 0,
                uris: void 0
            };
        ...
        __publicField(_assert_this_initialized(_this), "handleChangeRange", function() {
                ...
                return _ts_generator(this, function(_state) {
                    switch(_state.label){
                        ...
                        case 7:
                            ...
                            if (callback) {
                                callback(_object_spread_props(_object_spread({}, _this1.state, stateChanges), {
                                    type: TYPE.PROGRESS
                                }));
                            }
                            return [
        ...
        __publicField(_assert_this_initialized(_this), "handleClickTogglePlay", /*#__PURE__*/ _async_to_generator(function() {
            var isActive, error;
            return _ts_generator(this, function(_state) {
                switch(_state.label){
                    case 0:
        ...
        __publicField(_assert_this_initialized(_this), "handleClickPrevious", /*#__PURE__*/ _async_to_generator(function() {
            var error;
            return _ts_generator(this, function(_state) {
                switch(_state.label){
                    case 0:
        ...
        var _this4 = _assert_this_initialized(_this);
        __publicField(_assert_this_initialized(_this), "handleClickNext", /*#__PURE__*/ _async_to_generator(function() {
            var error;
            return _ts_generator(this, function(_state) {
                switch(_state.label){
                    case 0:
        ...
        var _this5 = _assert_this_initialized(_this);
        __publicField(_assert_this_initialized(_this), "handleClickDevice", function() {
            var _ref = _async_to_generator(function(deviceId) {
                var isUnsupported, _this_props, autoPlay, persistDeviceSelection, playerState, error;
                return _ts_generator(this, function(_state) {
                    switch(_state.label){
                        case 0:
                        ...
                        case 4:
                            ...
                            if (!(playerState && !playerState.is_playing && autoPlay)) return [
                                3,
                                6
                            ];
                            return [
        ...
        __publicField(_assert_this_initialized(_this), "handleFavoriteStatusChange", function(status) {
            var isSaved = _this.state.isSaved;
            _this.updateState({
                isSaved: status
            });
            if (isSaved !== status) {
                _this.handleCallback(_object_spread_props(_object_spread({}, _this.state), {
                    isSaved: status,
                    type: TYPE.FAVORITE
                }));
            }
        });
        var _this6 = _assert_this_initialized(_this);
        __publicField(_assert_this_initialized(_this), "handlePlayerErrors", function() {
            var _ref = _async_to_generator(function(type, message) {
        ...
        var _this7 = _assert_this_initialized(_this);
        __publicField(_assert_this_initialized(_this), "handlePlayerStateChanges", function() {
            var _ref = _async_to_generator(function(state) {
                var _this_player, paused, position, repeat_mode, shuffle2, _state_track_window, current_track, next_tracks, previous_tracks, isPlaying, volume, trackState, error;
                return _ts_generator(this, function(_state) {
                    switch(_state.label){
                        case 0:
                            _state.trys.push([
                            ...
                            paused = state.paused, position = state.position, repeat_mode = state.repeat_mode, shuffle2 = state.shuffle, _state_track_window = state.track_window, current_track = _state_track_window.current_track, next_tracks = _state_track_window.next_tracks, previous_tracks = _state_track_window.previous_tracks;
                            isPlaying = !paused;
                            return [
                                4,
                        ...
                        case 1:
                            ...
                            _this7.updateState(_object_spread({
                                error: "",
                                errorType: null,
                                isActive: true,
                                isPlaying: isPlaying,
        ...
        var _this8 = _assert_this_initialized(_this);
        __publicField(_assert_this_initialized(_this), "handlePlayerStatus", function() {
            var _ref = _async_to_generator(function(param) {
        ...
        __publicField(_assert_this_initialized(_this), "handleToggleMagnify", function() {
        ...
        __publicField(_assert_this_initialized(_this), "initializePlayer", function() {
            ...
            } : _this_props_getOAuthToken, getPlayer = _this_props.getPlayer, _this_props_name = _this_props.name, name = _this_props_name === void 0 ? "Spotify Web Player" : _this_props_name;
            if (!window.Spotify) {
                return;
            }
            _this.updateState({
            ...
            _this.player.addListener("autoplay_failed", /*#__PURE__*/ _async_to_generator(function() {
                return _ts_generator(this, function(_state) {
        ...
        __publicField(_assert_this_initialized(_this), "setExternalDevice", function(id) {
            _this.updateState({
                currentDeviceId: id,
                isPlaying: true
            });
        });
        var _this9 = _assert_this_initialized(_this);
        __publicField(_assert_this_initialized(_this), "setVolume", function() {
            var _ref = _async_to_generator(function(volume) {
                return _ts_generator(this, function(_state) {
                    switch(_state.label){
                        case 0:
        ...
        var _this10 = _assert_this_initialized(_this);
        __publicField(_assert_this_initialized(_this), "syncDevice", /*#__PURE__*/ _async_to_generator(function() {
            var deviceId, playerState, track, _playerState_progress_ms, error, state;
            return _ts_generator(this, function(_state) {
                switch(_state.label){
                    case 0:
                    ...
                    case 2:
                        ...
                        _this10.updateState({
                            ...
                            nextTracks: [],
                            previousTracks: [],
                            progressMs: playerState.item ? (_playerState_progress_ms = playerState.progress_ms) !== null && _playerState_progress_ms !== void 0 ? _playerState_progress_ms : 0 : 0,
                            status: STATUS.READY,
                            track: track,
                    ...
                    case 3:
                        ...
                        if (deviceId) {
                            _this10.updateState(_object_spread({
                                currentDeviceId: deviceId
                            }, state));
                            return [
                                2
        ...
        var _this11 = _assert_this_initialized(_this);
        __publicField(_assert_this_initialized(_this), "toggleOffset", /*#__PURE__*/ _async_to_generator(function() {
        ...
        var _this12 = _assert_this_initialized(_this);
        __publicField(_assert_this_initialized(_this), "togglePlay", /*#__PURE__*/ _async_to_generator(function() {
            ...
            return _ts_generator(this, function(_state) {
                switch(_state.label){
                    case 0:
                        ...
                        playOptions = _this12.getPlayOptions(getURIs(uris));
                        _state.label = 1;
                    case 1:
                        _state.trys.push([
                            1,
                        ...
                        return [
                            4,
                            play(_this12.token, _object_spread({
                                deviceId: currentDeviceId,
                                offset: offset
        ...
        var _this13 = _assert_this_initialized(_this);
        __publicField(_assert_this_initialized(_this), "updateSeekBar", /*#__PURE__*/ _async_to_generator(function() {
        ...
        __publicField(_assert_this_initialized(_this), "updateState", function(state) {
            if (!_this.isMounted) {
                return;
            }
    ...
    _create_class(SpotifyWebPlayer, [
        {
        ...
        },
        {
            ...
            value: function componentDidUpdate(previousProps, previousState) {
                var _this = this;
                return _async_to_generator(function() {
                    var _this_state, currentDeviceId, deviceId, isInitializing, isPlaying, repeat2, shuffle2, status, track, _this_props, autoPlay, layout, locale, offset, playProp, showSaveIcon, styles, syncExternalDevice, uris, isReady, playOptions, canPlay, shouldPlay, playerState, _playerState_device_id;
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                _this_state = _this.state, currentDeviceId = _this_state.currentDeviceId, deviceId = _this_state.deviceId, isInitializing = _this_state.isInitializing, isPlaying = _this_state.isPlaying, repeat2 = _this_state.repeat, shuffle2 = _this_state.shuffle, status = _this_state.status, track = _this_state.track;
                            ...
                            case 2:
                                if (!!(0, import_deep_equal.default)(previousProps.uris, uris)) return [
                                    3,
                                    6
                                ];
                            ...
                            case 16:
                                ...
                                if (playerState && playerState.is_playing && playerState.device.id !== deviceId) {
                                    ;
                                    _this.setExternalDevice((_playerState_device_id = playerState.device.id) !== null && _playerState_device_id !== void 0 ? _playerState_device_id : "");
                                }
                                _state.label = 17;
                            case 17:
        ...
        },
        {
            ...
            value: function render() {
                var _this_state = this.state, currentDeviceId = _this_state.currentDeviceId, deviceId = _this_state.deviceId, devices = _this_state.devices, error = _this_state.error, isActive = _this_state.isActive, isMagnified = _this_state.isMagnified, isPlaying = _this_state.isPlaying, isUnsupported = _this_state.isUnsupported, nextTracks = _this_state.nextTracks, playerPosition = _this_state.playerPosition, position = _this_state.position, progressMs = _this_state.progressMs, status = _this_state.status, track = _this_state.track, volume = _this_state.volume;
                var _this_props = this.props, components = _this_props.components, _this_props_hideAttribution = _this_props.hideAttribution, hideAttribution = _this_props_hideAttribution === void 0 ? false : _this_props_hideAttribution, _this_props_hideCoverArt = _this_props.hideCoverArt, hideCoverArt = _this_props_hideCoverArt === void 0 ? false : _this_props_hideCoverArt, _this_props_inlineVolume = _this_props.inlineVolume, inlineVolume = _this_props_inlineVolume === void 0 ? true : _this_props_inlineVolume, _this_props_layout = _this_props.layout, layout = _this_props_layout === void 0 ? "responsive" : _this_props_layout, showSaveIcon = _this_props.showSaveIcon, updateSavedStatus = _this_props.updateSavedStatus;
                var isReady = [
                    STATUS.READY,
                    STATUS.UNSUPPORTED
                ].includes(status);
